...
public class RudderGameApp extends Application {
    private static final Logger LOGGER = LogManager.getLogger(RudderGameApp.class);
    ...
    public void start(Stage primaryStage) {
        ...
        try {
            ...
            loader.setLocation(ClientApp.class.getResource("/LoginScreen.fxml"));
    ...
    public void showGameBoard(String name, boolean online) {     
        try {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(ClientApp.class.getResource("/RudderGame.fxml"));
